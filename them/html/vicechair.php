                                                ...
                                                <td>
                                                    <form action="course-confirm.php?userid=<?php echo $getstudent['user_id']; ?>" method="POST">
                                                        <?php 
                                                            ...
                                                            if($conf==1){ ?>
                                                                <input class="btn btn-success ml-4" type="submit" value="Confirmed" name="courseconfirm">
                                                            <?php }
                                                            else if($conf==0){ ?>
                                                                <input class="btn btn-danger ml-4" type="submit" value="Confirm" name="courseconfirm">
                                                            <?php } ?>                           
                                                </td>
                                                    </form>
                                            </tr>
